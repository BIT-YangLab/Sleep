...
% construct individual atlas for subcortex by Lisa2019(Ji et al., 2015)
...
for stagei = 1:5
    ...
    for subi = 1:size(network_label_all, 2)
        ...
        label_subcortex = (mi);
        label_whole = [network_label_all{stagei, subi}; label_subcortex];
        network_label_subcortex_lisa{stagei, subi} = label_whole;
